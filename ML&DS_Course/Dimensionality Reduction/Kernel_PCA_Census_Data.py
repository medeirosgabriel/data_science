...
kpca =  KernelPCA(n_components = 6, kernel="rbf"); # 6 principal components
f_train = kpca.fit_transform(f_train)
f_test = kpca.transform(f_test)
components = kpca.explained_variance_ratio_
